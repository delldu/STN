...
class TPSGridGen(nn.Module):
    def __init__(self, target_height, target_width, target_control_points):
        ...
        # target_height = 28
        # target_width = 28
        # target_control_points = tensor([[-0.9000, -0.9000],
        #         [-0.3000, -0.9000], ...
        #         [ 0.3000,  0.9000],
        #         [ 0.9000,  0.9000]])
        # (Pdb) pp target_control_points.size()
        # torch.Size([16, 2])
        ...
        # (Pdb) pp target_control_partial_repr.size()
        # torch.Size([16, 16])
